 ...
 */
    ...
    let menuOptions = ["Inicio", "Products", "About Us"]  
    let elementUl = document.createElement("ul")
    console.log(elementUl)
    elementUl.setAttribute("id", "menu")
    elementUl.setAttribute("class", "menu")
    


    const itemMenu = menuOptions.forEach((cv) =>{
      let listOptions = document.createElement ("li")
      listOptions.textContent = `${cv}`
      elementUl.appendChild(listOptions)
      listOptions.setAttribute("class", "item__menu")
})
...
let tbody = document.querySelector("tbody") //seleccionar la etiqueta tabla
    koder.forEach((koder, index, arr) =>{  // se crea un forEach para identar el contenido del objeto
